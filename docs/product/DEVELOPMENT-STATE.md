...
| F002 | 01 | open-graph-mcp | Pin Toolchain and Restore Typecheck Gate | cognitive_line_test_automation | - | COMPLETED |
...
| F002 | 18 | open-graph-mcp | Implement the Cancellation Fault Injection Probe | cognitive_line_test_automation | IMPLEMENTATION | COMPLETED |
...
| F002 | 21 | open-graph-mcp | Add the Test Index and Documentation Reconciliation Gate | cognitive_line_test_automation | - | NOT_STARTED |
| F002 | 22 | open-graph-mcp | Add the Flake Ledger and Quarantine Policy | cognitive_line_test_automation | - | NOT_STARTED |
| F002 | 23 | open-graph-mcp | Compose Quality Gates and Publish the Suite Verdict | cognitive_line_test_automation | - | NOT_STARTED |
